package jdbc.lesson4.hw1.constants;
...
public class Constants {
    ...
    public static final String SQL_REQUEST_STORAGE_FIND_SUM = "SELECT SUM(FILES.FILE_SIZE) FROM STORAGE JOIN FILES ON FILES.STORAGE_ID = STORAGE.STORAGE_ID WHERE STORAGE.STORAGE_ID =  ?";
}